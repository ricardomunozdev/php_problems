    ...
    public function datos3($bus, $tipo) {
        ...
        switch ($this->tipo){
            ...
            case 'apellido': $this->consulta=$this->con->query("SELECT * FROM usuarios where apellido LIKE '%$this->buscar%'");
                break;
            case 'telefono': $this->consulta=$this->con->query("SELECT * FROM usuarios where telefono LIKE '%$this->buscar%'");
        }
        ...
        if ($this->recorrido = $this->consulta->fetch_array()){
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="apellido" required="" 
                       value="<?php echo $this->recorrido['apellido'];?>">
            </div>
            <div class="form-group">
                <label>DNI</label>
                <input type="number" class="form-control" name="dni" required="" 
                       value="<?php echo $this->recorrido['dni'];?>">
            </div>
            <div class="form-group">
                <label>NACIMIENTO</label>
                <input type="date" class="form-control" name="nacimiento" required="" 
                       value="<?php echo $this->recorrido['nacimiento'];?>">
            </div>
            <div class="form-group">
                <label>PROVINCIA</label>
                <input type="text" class="form-control" name="provincia" required="" 
                       value="<?php echo $this->recorrido['provincia'];?>">
            </div>
            <div class="form-group">
                <label>LOCALIDAD</label>
                <input type="text" class="form-control" name="localidad" required="" 
                       value="<?php echo $this->recorrido['localidad'];?>">
            </div>
            <div class="form-group">
                <label>DIRECCION</label>
                <input type="text" class="form-control" name="direccion" required="" 
                       value="<?php echo $this->recorrido['direccion'];?>">
            </div>
            <div class="form-group">
                <label>TELEFONO</label>
                <input type="text" class="form-control" name="telefono" required="" 
                       value="<?php echo $this->recorrido['telefono'];?>">
            </div>
            <div class="form-group">
                <label>EMAIL</label>
                <input type="text" class="form-control" name="email" required="" 
                       value="<?php echo $this->recorrido['email'];?>">
            </div>
            <div class="form-group">
                <label>SEXO</label>
                <input type="text" class="form-control" name="sexo" required="" 
                       value="<?php echo $this->recorrido['sexo'];?>">
            </div>
            <div class="form-group">
...
class datosEliminar extends conexion{
    ...
    public function eliminar($id) {
        ...
        if ($this->recorrido = $this->consulta->fetch_array()){
            ...
            <div class="form-group">
                <label>PRIVILEGIO</label>
                <input type="text" class="form-control" name="privilegio" required="" 
                       value="<?php echo $this->recorrido['privilegio'];?>">
            </div>
            <div class="form-group">
                <label for="foto">Foto del usuario</label>
