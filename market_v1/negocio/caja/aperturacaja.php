...
<body>
    ...
    <form id="caja" action="aperturacaja.php" method="GET">
        ...
        <div class="form-group">
            ...
            <input class="form-control" readonly="" type="text" name="fechacaja" id="fechacaja" value="<?php date_default_timezone_set('America/Argentina/Tucuman');
                                                                                                        echo date('Y-m-d'); ?>">
        </div>
        <div class="form-group">
            <label for="horainicial">Hora Inicial</label>
            <input class="form-control" readonly="" type="text" name="horainicial" id="horainicial" value="<?php date_default_timezone_set('America/Argentina/Tucuman');
                                                                                                            echo date('H:i:s'); ?>">
        </div>
        <div>
